...
| 状态 | 颜色 | 触发条件 | 可转换到 |
|------|------|----------|----------|
| 待船司分舱 | 灰色 | Excel 导入且放舱确认=N/空 | 确认放舱、已过期 |
| 已过期 | 深灰色 | 待船司分舱 + 超过截单时间 | 确认放舱（恢复，需更新截单时间） |
| 确认放舱 | 🟢 绿色 | 船司确认 / 业务退回 / 已退关恢复 / 已过期恢复 | 业务已售、待退关 |
| 业务已售 | 🔵 蓝色 | 商务分配给业务 | 确认放舱（业务退回） |
| 待退关 | 🟠 橙色 | 确认放舱 + 超过截单时间 | 已退关、确认放舱（恢复，需更新截单时间） |
| 已退关 | 深灰色 | 商务确认退关 | 确认放舱（恢复，需更新截单时间） |
